<main<header>
        ...
        <header>
            <div class="criticas-fundo">
                <div class="criticas-title">
                    <h1 class="icon-blog">
                        <?php if($totalFilmePesquisado>1){
                       echo $totalFilmePesquisado." filmes encontrados";
                    }else{
                       echo $totalFilmePesquisado. " filme encontrado"; 
                    }
                            ?></h1>
                </div>
            </div>            
        ...
        <section class="criticas-filmes">
            ...
            <?php
                if(!empty($infoFilmePesquisado)){
                    foreach($infoFilmePesquisado as $filmes){
                        ?>
                        <div class="bx">
